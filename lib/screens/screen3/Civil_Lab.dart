...
class Civil_Lab extends StatelessWidget {
  const Civil_Lab({super.key});
  @override
...
class _LabPDFState extends State<LabPDF> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      ).cachedFromUrl('https://aec.edu.in/thubzone/syllabus/10.%20AR20_AIML%201%20TO%20VIII%20SYLLABUS_02.09.2023.pdf'),
    );
  }
}